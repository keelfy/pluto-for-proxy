    ...
    return (
        <svg width="270" height="80" fill="none" xmlns="http://www.w3.org/2000/svg" className="">
            <g clip-path="url(#a)">
                ...
                <mask id="c" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="-21" y="-20" width="311" height="121">
                    <path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
                </mask>
                <g mask="url(#c)">
                ...
                <mask id="d" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="-21" y="-20" width="311" height="121">
                    <path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
                </mask>
                <g mask="url(#d)">
                    <path d="M41.4 38.9 20.1 61.5a5.7 5.7 0 0 0 8.5 3.4l24-13.8-11.2-12.2Z" fill="#EA4335" />
                </g>
                <mask id="e" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="-21" y="-20" width="311" height="121">
                    <path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
                </mask>
                <g mask="url(#e)">
                    <path d="m63 35-10.4-6L41 39.4 52.7 51l10.2-6a5.8 5.8 0 0 0 .1-10Z" fill="#FBBC04" />
                </g>
                <mask id="f" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="-21" y="-20" width="311" height="121">
                    <path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
                </mask>
                <g mask="url(#f)">
                    <path d="M20.1 18.6 20 20v40l.2 1.5 22-22-22-21Z" fill="#4285F4" />
                </g>
                <mask id="g" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="-21" y="-20" width="311" height="121">
                    <path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
                </mask>
                <g mask="url(#g)">
                    <path d="m41.6 40 11-11-24-13.9a5.8 5.8 0 0 0-8.5 3.5L41.6 40Z" fill="#34A853" />
                </g>
                <mask id="h" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="-21" y="-20" width="311" height="121">
                    <path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
                </mask>
                <g mask="url(#h)">
                ...
                <mask id="i" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="-21" y="-20" width="311" height="121">
                    <path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
                </mask>
                <g mask="url(#i)">
                ...
                <mask id="j" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="-21" y="-20" width="311" height="121">
                    <path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
                </mask>
                <g mask="url(#j)">
                ...
                <mask id="k" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="-21" y="-20" width="311" height="121">
                    <path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
                </mask>
                <g mask="url(#k)">
                ...
                <mask id="l" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="-21" y="-20" width="311" height="121">
                    <path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
                </mask>
                <g mask="url(#l)">
                    <path d="M127.4 26h-1.6V15.5h-3.3V14h8.2v1.5h-3.3V26Z" fill="#fff" stroke="#fff" stroke-width=".3" stroke-miterlimit="10" />
                </g>
                <mask id="m" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="-21" y="-20" width="311" height="121">
                    <path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
                </mask>
                <g mask="url(#m)">
                ...
                <mask id="n" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="-21" y="-20" width="311" height="121">
                    <path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
                </mask>
                <g mask="url(#n)">
                    <path d="M143 26V14h8.7v12h-1.5V15.5h-5.6V26H143Z" fill="#fff" stroke="#fff" stroke-width=".3" stroke-miterlimit="10" />
                </g>
                <mask id="o" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="-21" y="-20" width="311" height="121">
                    <path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
                </mask>
                <g mask="url(#o)">
                    <path d="M154.5 26V14h1.5v5.1h6V14h1.6v12H162v-5.4h-6V26h-1.5Z" fill="#fff" stroke="#fff" stroke-width=".3" stroke-miterlimit="10" />
                </g>
                <mask id="p" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="-21" y="-20" width="311" height="121">
                    <path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
                </mask>
                <g mask="url(#p)">
                ...
                <mask id="q" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="-21" y="-20" width="311" height="121">
                    <path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
                </mask>
                <g mask="url(#q)">
                ...
                <mask id="r" style={{ maskType: "luminance" }} maskUnits="userSpaceOnUse" x="-21" y="-20" width="311" height="121">
                    <path d="M-20-20h310v120H-20V-20Z" fill="#fff" />
                </mask>
                <g mask="url(#r)">
