...
export default function GreetingsIcon({ className }: { className?: string }) {
    const { theme } = useTheme();

    return (
        <svg fill={theme === "light" ? "white" : "currentColor"} width="800px" height="800px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" className={cn(className, "iconify iconify--emojione")} preserveAspectRatio="xMidYMid meet">
            <g fill="#42ade2">
